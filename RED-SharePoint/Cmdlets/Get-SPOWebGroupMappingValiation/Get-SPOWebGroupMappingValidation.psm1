Function Get-SPOWebGroupMappingValidation
{
    ...
    $GroupPermissions = Get-PnPGroupPermissions -Identity $Entry.'Group Name'
    ...
    $GroupMappingEntry | Add-Member -MemberType NoteProperty -name "Web URL" -Value (Get-PnPConnection | selct URL)
